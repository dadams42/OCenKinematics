...
Full reference of Bañares-Hernández et al. (2025):

@ARTICLE{2025A&A...693A.104B,
       author = {{Ba{\~n}ares-Hern{\'a}ndez}, Andr{\'e}s and {Calore}, Francesca and {Martin Camalich}, Jorge and {Read}, Justin I.},
        title = "{New constraints on the central mass contents of Omega Centauri from combined stellar kinematics and pulsar timing}",
      journal = {\aap},
     keywords = {stars: black holes, stars: kinematics and dynamics, pulsars: general, galaxies: kinematics and dynamics, galaxies: star clusters: general, globular clusters: individual: {\ensuremath{\omega}} Centauri, Astrophysics - Astrophysics of Galaxies},
         year = 2025,
        month = jan,
       volume = {693},
          eid = {A104},
...
archivePrefix = {arXiv},
 ...
 primaryClass = {astro-ph.GA},
       adsurl = {https://ui.adsabs.harvard.edu/abs/2025A&A...693A.104B},
